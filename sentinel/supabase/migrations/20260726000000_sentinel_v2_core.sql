-- ============================================================
-- Sentinel v2 — Personal AI OS core schema (migration)
-- Timestamped migration: 20260726000000
-- NOTE: sentinel_executor password is a placeholder here. Use
-- the provided helper script `scripts/set_sentinel_secret.sh`
-- to generate and apply a real password (do NOT commit secrets).
-- ============================================================
...
create role sentinel_executor login password '__SENTINEL_EXECUTOR_PASSWORD__' noinherit;
